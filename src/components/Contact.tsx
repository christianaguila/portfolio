...
export default function Contact() {
  return (
    <SectionWrapper id="contact" className="py-24 lg:py-32 bg-bg-secondary">
      <div className="max-w-3xl mx-auto px-6 text-center">
        ...
        >
          Looking for AI automation that actually works? I build production-grade systems, not proofs of concept.
        </motion.p>
        ...
        >
          <a
            ...
            className="group inline-flex items-center gap-2 px-6 py-3 bg-accent text-white text-sm font-medium rounded-full hover:bg-accent-hover transition-colors duration-200"
          >
            <Mail size={16} />
